...
if (!$fileTmpLoc) { // if file not chosen
    ...
    exit();
} else if($fileSize > 506257400) { // if file is larger than we want to allow
    echo "ERROR: Your file was larger than 600kb in file size.";
    unlink($fileTmpLoc);
    exit();
} else if (!preg_match("/.(gif|jpg|png|rar)$/i", $fileName) ) {
